...
<div class="admintitle">
    ...
    <h1 align='center' style="">Update Student Information</h1>
</div>
...
<form action="updatedata.php" method="POST" enctype="multipart/form-data">
    <table border="0px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 0 15px;">
        <th colspan="2" style="text-align: center;background-color:grey; width: 140px; height: 50px;">Edit The Details Of Student</th>
